          ...
          <div className="pb-12 text-center md:pb-20">
            ...
            <div className="mx-auto max-w-3xl">
              <p className="text-xl text-indigo-200/65">
                At AppZad, we're passionate about transforming ideas into powerful web solutions. Our team specializes in creating custom platforms for Travel, Healthcare, and Hotel industries.
              </p>
            </div>
          </div>
          <div className="mx-auto max-w-3xl">
